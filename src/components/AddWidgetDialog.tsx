...
interface AddWidgetDialogProps {
  onAddWidget: (widget: { id: string; title: string; type: string; span: number }) => void;
}
      ...
      <DialogContent className="sm:max-w-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 max-h-96 overflow-y-auto">
          {availableWidgets.map((widget) => (
            <Card key={widget.id} className="hover:shadow-md transition-shadow cursor-pointer" onClick={() => handleAddWidget(widget)}>
